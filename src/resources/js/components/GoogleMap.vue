<template>
    <div>
        <button :class="buttonClass" v-on:click="toggle()">
            ...
            {{ show ? trans('hide_map') : trans('show_map') }}
            <div class="w-3 ml-3">
            ...
            return {
                ...
                lang: {
                    de: {
                        ...
                        cancel_button: 'Abbrechen (Karte nicht anzeigen)'
                    },
                    en: {
                        show_map: "Show map",
                        hide_map: "Hide map",
                        html: '<p>The map uses the service "Google Maps" by the third party service provider "Google Inc.".<br>Is this OK for you?</p><hr class="my-3"><p class="small text-sm">If you accept, Google Maps related cookies and data processings will be used.</p><p class="small text-sm">More information can be found in our <a href="/privacy" target="_blank">Privacy Policy</a>! There you can withdraw your consent anytime.</p>',
                        cancel_button: 'Cancel (do not display map)'
                    }
                }
            }
        },
        methods: {
            ...
            toggle: function () {
                if (!this.show && !this.isGoogleMapsAccepted()) {
                    return Swal.fire({
                        title: 'Google Maps',
                        html: this.trans('html'),
                        icon: "question",
                        showCancelButton: true,
                        confirmButtonColor: "#28a745",
                        cancelButtonColor: "#616161",
                        confirmButtonText: "OK",
                        cancelButtonText: this.trans('cancel_button')
                    }).then((result) => {
                        if(result.value) {
