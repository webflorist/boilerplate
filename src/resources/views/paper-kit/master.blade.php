...
@include('webflorist-boilerplate::paper-kit._partials.main-nav')

@include('webflorist-boilerplate::paper-kit._partials.header')

@include('webflorist-boilerplate::paper-kit._partials.main')

@include('webflorist-boilerplate::paper-kit._partials.footer')
