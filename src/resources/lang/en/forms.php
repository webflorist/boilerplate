...
return [
    ...
    'terms' => 'Terms',
    'accept_terms' => 'I accept the <a href="' . route_node_url('terms') . '" target="_blank">terms and conditions</a> as well as the <a href="' . route_node_url(config('boilerplate.privacy_policy_node')) . '" target="_blank">privacy policy</a>.',
