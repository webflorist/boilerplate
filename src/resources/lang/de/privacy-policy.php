...
return [
    ...
    'cookies' => '
        ...
        ',
    'first_party_cookies_intro' => 'Hier ist eine komplette Liste aller bei der Benutzung ' . ($i ? 'meiner' : 'unserer') . ' Webseite verwendeten technisch notwendigen <strong>&quot;Erstanbieter-Cookies&quot;</strong>:',
    ...
    'google_maps' => '
        <p>
            ' . ($i ? 'Meine' : 'Unsere') . ' Webseite bietet auf Anforderung die Funktionalität zur Darstellung interaktiver Karten (z.B. zur Erstellung von Anfahrtsplänen). Dabei wird der Dienst &quot;Google Maps&quot; (betrieben von <strong>Google LLC</strong>) verwendet.
        </p>
        <p>
